...
$createdDate = (isset($update_inward) && $update_inward['create_date'] != NULL?$update_inward['create_date']:'');
$last_edited_by=(isset($update_inward)?$update_inward['last_edit_by']:'');
$lastEditDate = (isset($update_inward) && $update_inward['last_edit']?$update_inward['last_edit']:'');
...
$checkedDate = (isset($update_inward) && $update_inward['checked_date'] != NULL?$update_inward['checked_date']:'');
$approved_by=(isset($update_inward) && $update_inward['pending_approve_by'] != NULL)?$this->ERPfunction->get_full_user_name($update_inward['pending_approve_by']):'';
$approvedDate = (isset($update_inward) && $update_inward['pending_approve_date'] != NULL?$update_inward['pending_approve_date']:'');
$accept_by=(isset($update_inward) && $update_inward['accept_by'] != NULL)?$this->ERPfunction->get_full_user_name($update_inward['accept_by']):'';
$acceptDate = (isset($update_inward) && $update_inward['accept_date'] != NULL ? $update_inward['accept_date']:'');
$paid = (isset($update_inward) && $update_inward['completed_by'] != NULL?$this->ERPfunction->get_full_user_name($update_inward['completed_by']):'');
$paidDate = (isset($update_inward) && $update_inward['completed_date'] != NULL ? $update_inward['completed_date']:'NULL');
...
<option value="<?php echo $retrive_data['project_id'];?>"<?php 
				...
				<div class="col-md-12 pull-right">
						<br><br><br>
						<div class="col-md-3">
							<?php echo "<b>Inward By:</b> ".$this->ERPfunction->get_full_user_name($created_by); ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Inward Date:</b> ".date("d-m-Y H:i",strtotime($createdDate)); ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Last Edited By:</b> ".$this->ERPfunction->get_full_user_name($last_edited_by); ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Last Edit Date:</b> ".date("d-m-Y H:i",strtotime($lastEditDate)); ?>
						</div>
						 <div class="col-md-3">
							 <?php echo "<b>Checked By:</b> ".$checked_by; ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Checked Date:</b> ".date("d-m-Y H:i",strtotime($checkedDate)); ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Approved By:</b> ".$approved_by; ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Approved Date:</b> ".date("d-m-Y H:i",strtotime($approvedDate)); ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Accepted by:</b> ".$accept_by; ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Accepted Date:</b> ".date("d-m-Y H:i",strtotime($acceptDate)); ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Paid:</b> ".$paid; ?>
						</div>
						<div class="col-md-3">
							 <?php echo "<b>Paid Date:</b> ".date("d-m-Y H:i",strtotime($paidDate)); ?>
						</div>
					</div>
				</div></div>
			</div>
