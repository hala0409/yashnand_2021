            ...
            <div id="scrolling-div">
				...
				?>
					...
					$total_amount += $retrive_material['amount'];
                        ...
                        <tr>
                            <!-- <td rowspan="17" valign="top"><strong> Remarks/Note:</strong></td> -->
                        ...
                        <td valign="top" style="border-bottom:0px;border-top:0px"><strong> </strong></td>
                            ...
                            <td colspan="11"><strong>Replacement Warrenty up to : <?php echo $erp_po_details["warranty"];?></span></strong> </td>
                        </tr>
                        <!-- </tbody>
                        </table>
                        ...
                        <tr>
                        <td valign="top" style="border-bottom:0px;border-top:0px"><strong> </strong></td>
                            <!-- <td rowspan="13" valign="top"><strong style='color:white'> Remarks/Note:</strong></td> -->
				...
				<tr>-->
                        ...
                        <tr>
                        <td valign="top" style="border-top:0px"><strong> </strong></td>
                            <td colspan="13">
                                <pre
                        ...
                        <tr>
                            <td valign="bottom" align="center" height="120" colspan="7">
                                <font size="4">
