...
<div class="col-md-12">
	...
	?>	    
		<table width="100%" border="1" >
			<tbody>
				<tr align="center">
					<!-- <td colspan="13"><?php echo $this->ERPfunction->viewheader_po($erp_po_details['po_date'],$erp_po_details['bill_mode']);?></td> -->
					<td colspan="13" style="height:140px">	
						<?php 
							$date = $erp_po_details['po_date'];
							if($erp_po_details['bill_mode'] != 'mp'){
								if($date >= "2019-03-01")
								{
				...
				<tr>
					...
					<td colspan="2" ><?php echo $this->ERPfunction->get_date($erp_po_details['po_date']); ?>  </td>
					<td colspan="1" ><strong>Time:</strong></td>
					<td colspan="2" ><?php echo $erp_po_details['po_time']; ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td valign="top" style="border-bottom:0px;"><strong> Remarks/Note:</strong></td>
					<td colspan="12" > 1) The above mentioned rate includes following:</td>
			</tr>
				<tr>
					<td valign="top" style="border-bottom:0px;border-top:0px"><strong> </strong></td>
			...
			<!--	<tr>
				...
				<tr>
					<td valign="top" style="border-bottom:0px;border-top:0px"><strong> </strong></td>
					<td colspan="12" >9) <?php echo $this->ERPfunction->getconditionofpowo($erp_po_details["po_date"],$erp_po_details["bill_mode"]); ?></td>
				</tr>
				<tr>
					<td valign="top" style="border-bottom:0px;border-top:0px"><strong> </strong></td>
					<td colspan="12" > 10) Payment will be done <strong><?php echo $erp_po_details["payment_days"];?></strong> days after date of delivery on site or bill submission which ever is later.</td>
				</tr>
