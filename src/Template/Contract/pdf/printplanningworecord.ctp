		...
		<table width="100%" border="1" >
			<tbody>
				...
				<tr>
					...
					<td colspan="12"><?php echo $this->ERPfunction->get_projectaddress($wo_data['project_id']); ?></td>
				</tr>
				<tr>
					<td colspan="2"><strong>Mode of Billing:</strong></td>
					<td colspan="4"> <?php echo ($wo_data['bill_mode'] == 'mp')?'Madhya Pradesh':ucfirst($wo_data['bill_mode']); ?></td>
				...
				<tr>
					...
					<td colspan="13" > 1) The above mentioned amount includes following:</td>
				</tr>
				</tbody>
<!-- remarks 1 start -->
