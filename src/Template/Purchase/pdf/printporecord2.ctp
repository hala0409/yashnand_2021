                ...
                <table width="100%" border="1">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="6"> <?php echo $erp_po_details['po_no']; ?></td>
                            <td colspan="2"><strong>Date:</strong> </td>
                            <td colspan="4"><?php echo $this->ERPfunction->get_date($erp_po_details['po_date']); ?>
                            </td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4"><strong><?php echo $this->ERPfunction->get_projectcode($erp_po_details['project_id']);?></strong>
                            </td>
					...
					<tr>-->
                        <tr>
                        <td valign="top" style="border-bottom:0px;border-top:0px;margin:0px;padding:0px"><strong> </strong></td>
                            <td colspan="12"> 9)
                        ...
                        <tr>
                        <td valign="top" style="border-bottom:0px;border-top:0px"><strong> </strong></td>
                            <td colspan="12"> 10) Payment will be done
