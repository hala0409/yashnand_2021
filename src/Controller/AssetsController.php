...
class AssetsController extends AppController
{
	...
	public function assetpo()
	{
		...
		if($this->role == "deputymanagerelectric")
		{
			...
			$material_list = $erp_material->find()->select(['material_id','material_title','material_item_code'])->where(['material_id IN'=>$material_ids,"material_code !="=>17]);
		}else{
			$material_list = $erp_material->find()->select(['material_id','material_title','material_item_code'])->where(["material_code !="=>17,"project_id"=>0]);
		}
