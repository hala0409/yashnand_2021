...
class AccountsController extends AppController
{
	...
	{	
    	...
    	$get_vendor_info=$erp_vendor_register->find()->select(['user_id','vendor_id','vendor_name']);
    ...
    public function grnalert(){
    	...
    	$meterial_list=$erp_material->find()->select(['material_id','material_title','material_item_code']);
			...
			if($post['party_type'] == 'oldparty')
			{
				if($post['payment_type'] == 'advance')
				{
					...
					if($erp_inward_advance->save($row))
					{
						...
						$message .= "Please Do Not Reply to this E-mail ID. This E-mail is system generated. For conformation and/or queries,<br />please contact:";
