...
return [
    ...
    'EmailTransport' => [
        ...
        'default' => [
            ...
            'port' => 465,
            'username' => 'noreply@yashnandeng.com',
            'password' => 'B7d[bBk?(f(4G%e=',
            'className' => 'Smtp',
            'ssl' => true
        ],
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'driver' => Mysql::class,
            'persistent' => false,
            'host' => env('DB_HOST', '34.131.158.108'),
            // 'host'=>'localhost',
            /*
             ...
             * It is recommended to set these options through your environment or app_local.php
             */
            'username' => env('DB_USERNAME', 'yashnanddb'),
            'password' => env('DB_PASSWORD', '$sjJj,J{Q{2{3S3.'),
            'database' => env('DB_NAME', 'yashnand_erp'),
            // 'username' => 'root',
            // 'password' => '',
            // 'database' => 'yashnanderp',
            /*
