				...
				else if($j== 10)
				{
					...
					if(self::retrive_accessrights($role,'addinwardbill')==1) {
						if($inward_status == 'approved'){
							$html .= "<a href='addinwardbill/{$uid}' style='display:none;' class='btn btn-succss btn-clean'><i class='icon-pencil'></i> Update</a>";
						}else {
							$html .= "<br><br> <a href='addinwardbill/{$uid}' class='btn btn-success btn-clean'><i class='icon-pencil'></i> Update</a>";
						}
					}
					...
					// }
					$html .= "<br><br><a href='viewbill/{$uid}' target='_blank' class='btn btn-primary btn-clean'><i class='icon-eye'></i> View</a>";
